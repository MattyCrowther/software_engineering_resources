#Arrays require all elements to be of same type but can be n dimensional.
...
student.marks <- array(c(class1.student.marks,class2.student.marks), dim=c(4,2,2)) #Array of matrix's dim = (num_rows,num_columns,num_sheets)
student.marks
