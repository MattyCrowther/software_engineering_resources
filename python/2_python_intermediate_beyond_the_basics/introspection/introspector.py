'''
brief: script which evaluates the object given as input and returns information on the object in the format:
	Type: type of object provided.
	Documentation: using intospect.getdoc()
	Attrributes: Table in format - Column 1 = Name of attr, Column2 = Value of attr
	Methods: Table in format - Column 1 = Name of method, Column2 = Desccription of method
		
'''
import inspect
import reprlib
import itertools
from sorted_set_cpy import SortedSet
