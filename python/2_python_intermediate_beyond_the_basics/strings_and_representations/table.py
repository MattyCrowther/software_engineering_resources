'''
Basic use for a class for tabular information, shows that a str implementation can be larger than repr and more logic.
This is because sometimes user information requires more information than devs.
'''
class Table:
