#Idea is to dynamically create test cases instead of typing up each test individually.
#The tennis_test_template is called into and using the setattr to set the params and also the assertion.
import unittest
