...
def main():
    print(dir(ChessCoordinate)) #See there is a attribute __new__
    print(ChessCoordinate.__new__) #Inherited __new__() allocates the object which is passed to __init__() as self.
    print(ChessCoordinate.__new__ is object.__new__) #Same
