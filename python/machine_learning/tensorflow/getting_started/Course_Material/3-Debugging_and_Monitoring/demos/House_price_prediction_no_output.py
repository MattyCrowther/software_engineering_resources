...
house_size = tf.placeholder("float", name="house_size") #Added name= here, allows us to debug easier by giving names to specific tensors instead will print something like Placeholder:0 as name
