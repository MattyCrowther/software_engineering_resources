...
x = tf.placeholder(tf.int32, shape=[3], name='x') #Unknown value untill runtime, 1D vector with 3 elements.
y = tf.placeholder(tf.int32, shape=[3], name='y')

sum_x = tf.reduce_sum(x, name="sum_x") #Can tell what we want to do with placeholders but not init untill session starts.
