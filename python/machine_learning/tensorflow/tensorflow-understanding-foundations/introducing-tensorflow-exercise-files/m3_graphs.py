...
#Each program has a default graph, however can have multiple in on program.
g1 = tf.Graph()

with g1.as_default(): #However have to set it as default so tf knows which graph to use.
